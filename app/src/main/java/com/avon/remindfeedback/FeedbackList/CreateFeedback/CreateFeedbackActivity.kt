...
import com.avon.remindfeedback.FeedbackList.CreateFeedback.ChoiceAdviser.ChoiceAdviserActivity
...
class CreateFeedbackActivity : AppCompatActivity(), ContractCreateFeedback.View {
    ...
    override fun setAdviser(portrait:String, introduction:String, nickname:String){
        ...
        if(!portrait.equals("")){
            Picasso.get().load("https://remindfeedback.s3.ap-northeast-2.amazonaws.com/"+portrait).into(create_Feedback_Profile_Image)
        }else{
